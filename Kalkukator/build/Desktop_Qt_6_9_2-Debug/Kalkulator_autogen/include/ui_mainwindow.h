...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Pasekmenu = new QMenuBar(MainWindow);
        Pasekmenu->setObjectName("Pasekmenu");
        Pasekmenu->setGeometry(QRect(0, 0, 460, 26));
        Menu = new QMenu(Pasekmenu);
        Menu->setObjectName("Menu");
        MainWindow->setMenuBar(Pasekmenu);

        Pasekmenu->addAction(Menu->menuAction());
        Menu->addAction(actionO_Autorze);
